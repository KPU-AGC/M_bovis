...
txids=$ref/Mbovis.txids
results=~/Documents/paddy/m_bovis/results
output_alignment=~/Documents/paddy/m_bovis/results/uvrC_mbovis_only_output_alignment
fasta_format_alignment_long=~/Documents/paddy/m_bovis/results/uvrC_mbovis_only_fasta_format_alignment_long
final_fasta=~/Documents/paddy/m_bovis/results/uvrC_mbovis_only_final_fasta
...
#BLAST search
#------------
blastn -db "nt" -query $uvrC_query -taxidlist $txids -num_threads 12 -max_target_seqs 5000 -parse_deflines -evalue 5e-2 -perc_identity 40 -outfmt '6 sscinames scomnames staxids sallgi sacc sseqid evalue qcovs pident sstart send sseq' -out $output_alignment/uvrC_mbovis_specific_q_txid_s.txt
